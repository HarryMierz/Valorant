-- Table: match_statistics.match_player

DROP TABLE IF EXISTS match_statistics.match_player;

CREATE TABLE IF NOT EXISTS match_statistics.match_player
(
    match_player_id integer NOT NULL GENERATED BY DEFAULT AS IDENTITY ( INCREMENT 1 START 1 MINVALUE 1 MAXVALUE 2147483647 CACHE 1 ),
    match_id integer,
    ...
    CONSTRAINT fk_match_match_player FOREIGN KEY (match_id)
...
ALTER TABLE IF EXISTS match_statistics.match_player
    OWNER to batch;